...
#define CANTP_P2P_RX 0
#define CANTP_P2P_TX 0
#ifndef USE_CANIF
#define CANIF_P2P_TX (CANIF_CANTP_BASEID+0)
#endif
#define CANTP_P2A_RX 1
#define CANTP_P2A_TX 1
#ifndef USE_CANIF
#define CANIF_P2A_TX (CANIF_CANTP_BASEID+1)
#endif
